      ...
      public void handle(MouseEvent e) {
        ...
        if ( index == 1 ) {
            ...
            if (playGame == null)
                ...
                levelsPaneNew = new LevelsPane("6X6", playGame.getStarsArray(6),dataStorage.getOpenMapArray(6));
            }
            ...
            if (playGame == null)
                ...
                levelsPaneNew = new LevelsPane("8X8", playGame.getStarsArray(8),dataStorage.getOpenMapArray(8));
            }
            //levelsPaneNew = new LevelsPane("8X8", engine.getStars(),dataStorage.getOpenMapArray(8));
            levelsPaneNew.addHandler( new ButtonListener(0));
            primaryStage1.updateMiddlePanel(levelsPaneNew);
            ...
            if (playGame == null)
                ...
                levelsPaneNew = new LevelsPane("10X10", playGame.getStarsArray(10),dataStorage.getOpenMapArray(10));
            }
           // levelsPaneNew = new LevelsPane("10X10", engine.getStars(),dataStorage.getOpenMapArray(10));
            levelsPaneNew.addHandler( new ButtonListener(0));
            primaryStage1.updateMiddlePanel(levelsPaneNew);

...
public class Engine{
	...
	private LinkedList<Node> moves = new LinkedList<Node>();
	private int volume;
...
//			MediaPlayer mediaPlayer = new MediaPlayer(gameWonSound);                                  IN THE FILE MANAGER
			gameManager.files.soundEffects[0].play();
		}
...
//			MediaPlayer mediaPlayer = new MediaPlayer(gameLostSound);					    		  IN THE FILE MANAGER
			gameManager.files.soundEffects[1].play();
		}
	}
